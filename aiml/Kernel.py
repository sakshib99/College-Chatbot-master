...
class Kernel:
    ...
    def __init__(self):
        ...
        self.setBotPredicate("family","College Enquiry Chat-bot based on AI")
        ...
        self.setBotPredicate("master","Group-1")
        self.setBotPredicate("birthplace","Nagpur")
        self.setBotPredicate("location","Nagpur")
        ...
        self.setBotPredicate("state","Maharashtra")
